                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            @foreach($menbrands as $menbrand)
                                <li><a href="" class="text-decoration-none px-1">{{$menbrand}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            @foreach ($womenbrands as $womenbrand)
                                <li><a href="" class="text-decoration-none px-1">{{$womenbrand}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="pb-3">
                        ...
                        <ul id="collapseThree" class="collapse list-unstyled pl-3">
                            @foreach ($kidbrands as $kidbrand)
                                <li><a class="text-decoration-none px-1" href="#">{{$kidbrand}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
