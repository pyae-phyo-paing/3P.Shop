...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="my-3 px-3">
            ...
            <a href="{{route('backend.user.create')}}" class="btn btn-primary float-end">+ Create New</a>
        </div>
        ...
        <div class="card">
          <div class="card-header bg-light">
            <h5 class="mb-0"><span><i class="fa-solid fa-table"></i></span> User List</h5>
          </div>
          <div class="card-body p-0">
              ...
              <tbody>
                ...
                @foreach ($users as $user)
                  <tr>
                    ...
                    <td>{{$user->role}}</td>
                    <td>
                        <a href="{{route('backend.user.edit',$user->id)}}" class="btn btn-sm btn-warning">Edit</a>
            ...
            <span class="float-end p-2">{{$users->links()}}</span>
          </div>
        </div>
      </div>
