...
@section('content')
    ...
    <div class="container mt-5">
        <!-- Page Header -->
        <div class="my-3 px-3">
            <h1 class="mt-4 d-inline">Brands</h1>
            <a href="{{route('backend.brand.create')}}" class="btn btn-primary float-end">+ Create New</a>
        </div>
        ...
        <div class="card">
          <div class="card-header bg-light">
            <h5 class="mb-0"><span><i class="fa-solid fa-table"></i></span> Brand List</h5>
          </div>
          <div class="card-body p-0">
              ...
              <tbody>
                ...
                @foreach ($brands as $brand)
                  <tr>
                    ...
                    <td>{{$brand->name}}</td>
                    <td>
                      <a href="{{route('backend.brand.edit',$brand->id)}}" class="btn btn-sm btn-warning">Edit</a>
            ...
            <span class="float-end p-2">{{$brands->links()}}</span>
          </div>
        </div>
      </div>
